...
public class PDFDebugger extends javax.swing.JFrame {
	...
	private void openMenuItemActionPerformed(java.awt.event.ActionEvent evt) {
		...
		ExtensionFileFilter pdfFilter = new ExtensionFileFilter(new String[] {
				"pdf", "PDF" }, "PDF Files");
	...
	private void readPDFFile(String file) throws Exception {
		...
		/*
		 * List pages = document.getDocumentCatalog().getAllPages(); for( int
		 * i=0; i<pages.size(); i++ ) { PageWrapper wrapper = new PageWrapper();
		 * wrapper.displayPage( (PDPage)pages.get(i) ); documentPanel.add(
		 * wrapper.getPanel() ); }
		 */
	}
