			...
			if (pdfFile == null) {
				...
				try {
					...
					while (iter.hasNext()) {
						...
						System.out.println("Pág.:" + pag);
						PDStream stream = page.getContents();
						String str = stream.getInputStreamAsString();
						System.out.println(str);

						// PDResources resources = page.getResources();
						// Map objects = resources.getXObjects();
						// if (objects != null) {
						// Iterator objIter = objects.keySet().iterator();
						// while (objIter.hasNext()) {
						// String key = (String) objIter.next();
						// System.out.println(key);
						// Object obj = (PDXObjectImage) objects
						// .get(key);
						...
						// PDXObjectImage image = (PDXObjectImage) images
						// .get(key);
						// String name = null;
						// if (addKey) {
